 ...
 */
export function encodeUlnConfig(params) {
    const { confirmations, requiredDvns, optionalDvns = [], optionalDvnThreshold = 0, } = params;
 ...
 */
export function encodeExecutorConfig(params) {
    return [
...
export function sortDvns(addresses) {
