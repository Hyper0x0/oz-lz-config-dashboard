...
export const LZ_CHAINS: LZChain[] = [
  ...
  { eid: 40231, chainId: 421614,   chainKey: 'arbitrum-sepolia', name: 'Arbitrum Sepolia',  endpoint: TESTNET_ENDPOINT, rpc: 'https://sepolia-rollup.arbitrum.io/rpc',       rpcFallback: 'https://arbitrum-sepolia.drpc.org',           isTestnet: true,  defaults: TEST_DEFAULTS },
